...
const Recipe = ({ recipe }) => {
  return (
    <div className="hover:scale-x-105 hover:scale-y-105 duration-300 recipe w-80 overflow-hidden bg-white/75 rounded-2xl shadow-xl p-5 shadow-rose-100 border-2 border-white  flex flex-col gap-5">
      ...
      <div className="texts">
        ...
        <h2 className="title text-2xl font-semibold truncate hover:text-green-500">
          {recipe.title}
        </h2>
        <Link
